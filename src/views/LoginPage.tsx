...
export const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!success) {
        setErrors({ general: 'فشل في تسجيل الدخول. يرجى التحقق من البيانات والمحاولة مرة أخرى.' })
      }
    } catch (error) {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setErrors({ general: 'فشل في تسجيل الدخول عبر Google. يرجى المحاولة مرة أخرى.' })
    } finally {
      setIsSubmitting(false)
    }
  }
      ...
      <Card className="w-full max-w-md p-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">
            مرحباً بك في منصة النشاط الطلابي
          </h1>
          <p className="text-gray-600">
            قم بتسجيل الدخول لحسابك للمتابعة
          </p>
        </div>
